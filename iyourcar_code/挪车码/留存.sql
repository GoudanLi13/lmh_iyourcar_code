...
where active_time is not null and substr(active_time,0,10) between '2019-11-15' and '2020-06-30';


-- 输出第一批挪车码激活情况数据
select count(distinct uid) as `第一批激活人数`
from iyourcar_dw.stage_all_service_day_iyourcar_activity_privilege_park_code
where uuid not like "1116%" and uuid not like "0217%" and active_time is not null and substr(active_time,0,10) between '2020-02-09' and '2020-06-30';
...
from iyourcar_dw.stage_all_service_day_iyourcar_activity_privilege_park_code
where uuid like "1116%" and active_time is not null and substr(active_time,0,10) between '2020-02-09' and '2020-06-30';


-- 输出第三批挪车码激活情况数据
select count(distinct uid) as `第三批激活人数`
from iyourcar_dw.stage_all_service_day_iyourcar_activity_privilege_park_code
where uuid like "0217%" and active_time is not null and substr(active_time,0,10) between '2020-03-01' and '2020-06-30';
...
where pcode.active_time is not null and app_active.action_status = 1 and app_active.d <='2020-06-30' and app_active.d >='2019-11-15'
...
and  substr(orders.ordertime,0,10) <= '2020-06-30' and substr(orders.ordertime,0,10) >= '2019-11-15'
and substr(pcode.active_time,0,10) between '2019-11-15' and '2020-06-30';
...
iyourcar_dw.stage_all_service_day_iyourcar_mall_order_mall_score_order as orders
on pcode.uid = orders.uid
where pcode.active_time is not null and substr(pcode.active_time,0,10) <= '2020-06-30'
and orders.order_status in (1,2,3)
and  substr(orders.ordertime,0,10) <= '2020-06-30' and substr(orders.ordertime,0,10) >= '2019-11-15'
and substr(pcode.active_time,0,10) between '2019-11-15' and '2020-06-30';
...
where substr(ordertime,0,10) <= '2020-06-30' and substr(ordertime,0,10) >= '2019-11-15'
...
and  substr(orders.ordertime,0,10) <= '2020-06-30' and substr(orders.ordertime,0,10) >= '2020-02-09'
and substr(pcode.active_time,0,10) between '2020-02-09' and '2020-06-30';
...
on pcode.uid = orders.uid
where pcode.active_time is not null
and orders.order_status in (1,2,3) and  substr(orders.ordertime,0,10) <= '2020-06-30' and substr(orders.ordertime,0,10) >= '2020-03-01'
and pcode.uuid  like "0217%"
and substr(pcode.active_time,0,10) between '2020-03-01' and '2020-06-30';
...
----跑到了这里！！！！！！
select count(distinct pcode.uid) as `2_new_GMV_uid_count`  from iyourcar_dw.stage_all_service_day_iyourcar_activity_privilege_park_code as pcode
inner join
tmp.dwd_ycyh_user_day_app_active  as app_active
on pcode.uid = app_active.uid and substr(pcode.active_time,0,10) = app_active.d
inner join
...
--第三批
-- 输出挪车码GMV-APP新用户数据
select sum(all_price)/100 as `3_new_GMV`  from iyourcar_dw.stage_all_service_day_iyourcar_activity_privilege_park_code as pcode
inner join
tmp.dwd_ycyh_user_day_app_active  as app_active
on pcode.uid = app_active.uid and substr(pcode.active_time,0,10) = app_active.d
inner join
...
select count(distinct pcode.uid) as `3_new_GMV_uid_count`  from iyourcar_dw.stage_all_service_day_iyourcar_activity_privilege_park_code as pcode
inner join
tmp.dwd_ycyh_user_day_app_active  as app_active
on pcode.uid = app_active.uid and substr(pcode.active_time,0,10) = app_active.d
inner join
...
--GMV
-- 输出挪车码GMV-小程序新用户数据
select sum(all_price)/100 as `all_new_GMV_wxapp`  from iyourcar_dw.stage_all_service_day_iyourcar_activity_privilege_park_code as pcode
inner join
tmp.dwd_ycyh_user_day_wxapp_active  as app_active
on pcode.uid = app_active.uid and substr(pcode.active_time,0,10) = app_active.d
inner join
...
--GMV
-- 输出挪车码GMV-小程序新用户数据
select sum(all_price)/100 as `0115-0208_all_new_GMV_wxapp`  from iyourcar_dw.stage_all_service_day_iyourcar_activity_privilege_park_code as pcode
inner join
tmp.dwd_ycyh_user_day_wxapp_active  as app_active
on pcode.uid = app_active.uid and substr(pcode.active_time,0,10) = app_active.d
inner join
...
and  substr(orders.ordertime,0,10) <= '2020-06-30' and substr(orders.ordertime,0,10) >= '2019-11-15'
and substr(pcode.active_time,0,10) between '2019-11-15' and '2020-02-08'
select count(distinct pcode.uid) as `0115-0208_all_new_GMV_wxapp_uid_count`  from iyourcar_dw.stage_all_service_day_iyourcar_activity_privilege_park_code as pcode
inner join
tmp.dwd_ycyh_user_day_wxapp_active  as app_active
on pcode.uid = app_active.uid and substr(pcode.active_time,0,10) = app_active.d
inner join
...
--第一批
-- 输出挪车码GMV-小程序新用户数据
select sum(all_price)/100 as `1_new_GMV_wxapp`  from iyourcar_dw.stage_all_service_day_iyourcar_activity_privilege_park_code as pcode
inner join
tmp.dwd_ycyh_user_day_wxapp_active  as app_active
on pcode.uid = app_active.uid and substr(pcode.active_time,0,10) = app_active.d
inner join
...
and  substr(orders.ordertime,0,10) <= '2020-06-30' and substr(orders.ordertime,0,10) >= '2020-02-09'
and substr(pcode.active_time,0,10) between '2020-02-09' and '2020-06-30'
select count(distinct pcode.uid) as `1_new_GMV_wxapp_uid_count`  from iyourcar_dw.stage_all_service_day_iyourcar_activity_privilege_park_code as pcode
inner join
tmp.dwd_ycyh_user_day_wxapp_active  as app_active
on pcode.uid = app_active.uid and substr(pcode.active_time,0,10) = app_active.d
inner join
...
--第二批
-- 输出挪车码GMV-小程序新用户数据
select sum(all_price)/100 as `2_new_GMV_wxapp`  from iyourcar_dw.stage_all_service_day_iyourcar_activity_privilege_park_code as pcode
inner join
tmp.dwd_ycyh_user_day_wxapp_active  as app_active
on pcode.uid = app_active.uid and substr(pcode.active_time,0,10) = app_active.d
inner join
...
and  substr(orders.ordertime,0,10) <= '2020-06-30' and substr(orders.ordertime,0,10) >= '2020-02-09'
and substr(pcode.active_time,0,10) between '2020-02-09' and '2020-06-30'
select count(distinct pcode.uid) as `2_new_GMV_wxapp_uid_count`  from iyourcar_dw.stage_all_service_day_iyourcar_activity_privilege_park_code as pcode
inner join
tmp.dwd_ycyh_user_day_wxapp_active  as app_active
on pcode.uid = app_active.uid and substr(pcode.active_time,0,10) = app_active.d
inner join
...
--第三批
-- 输出挪车码GMV-小程序新用户数据
select sum(all_price)/100 as `3_new_GMV_wxapp`  from iyourcar_dw.stage_all_service_day_iyourcar_activity_privilege_park_code as pcode
inner join
tmp.dwd_ycyh_user_day_wxapp_active  as app_active
on pcode.uid = app_active.uid and substr(pcode.active_time,0,10) = app_active.d
inner join
...
and orders.order_status in (1,2,3)
and pcode.uuid  like "0217%"
and substr(orders.ordertime,0,10) <= '2020-06-30' and substr(orders.ordertime,0,10) >= '2020-03-01'
and substr(pcode.active_time,0,10) between '2020-03-01' and '2020-06-30'
select count(distinct pcode.uid) as `3_new_GMV_wxapp_uid_count`  from iyourcar_dw.stage_all_service_day_iyourcar_activity_privilege_park_code as pcode
inner join
tmp.dwd_ycyh_user_day_wxapp_active  as app_active
on pcode.uid = app_active.uid and substr(pcode.active_time,0,10) = app_active.d
inner join
